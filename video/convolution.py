from utils_track import get_conv
import numpy as np
...
human_conv = get_conv('crops/1/292.jpg', 5)
counter = 0

for id in [1, 2, 4, 5, 7, 8, 9, 11, 12, 13, 14, 15, 16, 17]:
...
with open('convolutions/convolution_30.txt', "w") as file:
